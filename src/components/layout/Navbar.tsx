...
//           {/* Menu */}
//           <nav className="flex-1 flex flex-col items-center justify-center gap-8 text-lg font-semibold mt-10">
//             {sections.map((id) => (
//               <a
//                 key={id}
//                 href={`#${id}`}
          ...
          <div className="w-full px-4 lg:px-8 xl:px-12">
            <div className="flex items-center justify-between h-20">
              ...
              <div className="hidden md:flex items-center gap-6 text-white">
                ...
                <a
                  href="tel:+523525015754"
                  className="flex items-center gap-2 font-bold hover:text-secondary"
                >
                  <HiOutlinePhone size={16} />
                  352 501 5754
                </a>
